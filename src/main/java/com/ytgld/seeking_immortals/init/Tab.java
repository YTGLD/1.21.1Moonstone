...
public class Tab {
    ...
    public static final DeferredHolder<CreativeModeTab,?> ITEM = TABS.register("moonstone",()-> CreativeModeTab.builder()
            ...
            .displayItems((a,b)->{
                ...
                b.accept(new ItemStack(Items.alchemy_pot.get()));
                b.accept(new ItemStack(Items.vientiane_cauldron.get()));
                b.accept(new ItemStack(Items.concentrate.get()));
