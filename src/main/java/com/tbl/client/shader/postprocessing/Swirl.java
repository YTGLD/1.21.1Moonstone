...
public class Swirl extends PostProcessingEffect<Swirl> {
	...
	protected ResourceLocation[] getShaders() {
		return new ResourceLocation[] {TBL.prefix("thebetweenlands:shaders/postprocessing/swirl/swirl.vsh"), TBL.prefix("thebetweenlands:shaders/postprocessing/swirl/swirl.fsh")};
	}
