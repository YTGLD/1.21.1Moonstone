...
public class GroundFog extends PostProcessingEffect<GroundFog> {
	public static final ResourceLocation TEXTURE_GROUND_FOG_HEIGHT_MAP = TBL.prefix("textures/shaders/ground_fog_height_map.png");
	...
	protected ResourceLocation[] getShaders() {
		return new ResourceLocation[] {TBL.prefix("shaders/postprocessing/ground_fog/ground_fog.vsh"), TBL.prefix("shaders/postprocessing/ground_fog/ground_fog.fsh")};
	}
