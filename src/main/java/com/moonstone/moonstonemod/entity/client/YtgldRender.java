...
public class YtgldRender  extends MobRenderer<ytgld, NModel<ytgld>> {
    ...
    private static final ResourceLocation PULSATING_SPOTS_TEXTURE_1 =  ResourceLocation.fromNamespaceAndPath(MoonStoneMod.MODID,"textures/entity/ytgld_boot.png");
    private static final ResourceLocation PULSATING_SPOTS_TEXTURE_2 =   ResourceLocation.fromNamespaceAndPath(MoonStoneMod.MODID,"textures/entity/ytgld_boot_2.png");
