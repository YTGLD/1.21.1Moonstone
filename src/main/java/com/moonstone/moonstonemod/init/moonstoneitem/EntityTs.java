...
public class EntityTs {
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<com.moonstone.moonstonemod.entity.attack_blood>> attack_blood = REGISTRY.register("attack_blood",
            ()-> EntityType.Builder.of(com.moonstone.moonstonemod.entity.attack_blood::new, MobCategory.MISC).sized(0.1f, 0.2f).clientTrackingRange(50).build("attack_blood"));
    public static final DeferredHolder<EntityType<?>,EntityType<com.moonstone.moonstonemod.entity.owner_blood>> owner_blood = REGISTRY.register("owner_blood",
            ()-> EntityType.Builder.of(com.moonstone.moonstonemod.entity.owner_blood::new, MobCategory.MISC).sized(0.1f, 0.1f).clientTrackingRange(50).build("owner_blood"));
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<com.moonstone.moonstonemod.entity.ytgld>> ytgld = REGISTRY.register("ytgld",
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<com.moonstone.moonstonemod.entity.the_sword>> the_sword = REGISTRY.register("the_sword",
            ()-> EntityType.Builder.of(com.moonstone.moonstonemod.entity.the_sword::new, MobCategory.MISC).sized(1, 1).clientTrackingRange(50).build("the_sword"));
    @SubscribeEvent
    public static void EntityAttributeCreationEvent(EntityAttributeCreationEvent event){
        ...
        event.put(EntityTs.ytgld.get(),  com.moonstone.moonstonemod.entity.ytgld.createAttributes().build());

        event.put(EntityTs.the_sword.get(),  com.moonstone.moonstonemod.entity.the_sword.createAttributes().build());
